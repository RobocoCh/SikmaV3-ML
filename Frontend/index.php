...
<head>
    ...
    <link rel="icon" href="assets/images/Sikma.jpg" type="image/png">
...
<body class="<?php echo $activeTheme; ?>">
    ...
    <div class="auth-container" id="authContainer" style="<?php echo $isLoggedIn ? 'display: none;' : 'display: flex;'; ?>">
        <div class="auth-form-wrapper">
            <div class="logo-auth">
                <img src="assets/images/Sikma.jpg" alt="Logo SIKMA">
            </div>
    ...
    <div class="app-container" id="appContainer" style="<?php echo $isLoggedIn ? 'display: flex;' : 'display: none;'; ?>">
        <aside class="sidebar" id="pageSidebar">
            ...
            <div class="logo">
                <img src="assets/images/Sikma.jpg" alt="Logo SIKMA Alternatif">
            </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        // Penting: SELALU panggil ini agar event handler logout terpasang!
